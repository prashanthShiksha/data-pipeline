...
class ObservationQuestionsFunction(postgresUtil: PostgresUtil, config: ObservationStreamConfig, questionTable: String) {
  ...
  def textQuestionType(payload: Option[Map[String, Any]], question_id: String, solution_id: String, solution_name: String, submission_id: String,
    ...
    insertQuestion(payload, question_id, solution_id, solution_name, submission_id, user_id, submission_number, value, state_name, district_name, block_name, cluster_name, school_name, has_parent_question, parent_question_text, "text")
  }
  ...
  def radioQuestionType(payload: Option[Map[String, Any]], question_id: String, solution_id: String, solution_name: String, submission_id: String,
                         ...
                         parent_question_text: String): Unit = {
    insertQuestion(payload, question_id, solution_id, solution_name, submission_id, user_id, submission_number, value, state_name, district_name, block_name, cluster_name, school_name, has_parent_question, parent_question_text, "radio", Some(score))
  }
  ...
  def dateQuestionType(payload: Option[Map[String, Any]], question_id: String, solution_id: String, solution_name: String, submission_id: String,
                        ...
                        block_name: String, cluster_name: String, school_name: String, score: Integer, has_parent_question: Boolean,
                        parent_question_text: String): Unit = {
    insertQuestion(payload, question_id, solution_id, solution_name, submission_id, user_id, submission_number, value, state_name, district_name, block_name, cluster_name, school_name, has_parent_question, parent_question_text, "date", Some(score))
  }
  ...
  def multiselectQuestionType(payload: Option[Map[String, Any]], question_id: String, solution_id: String, solution_name: String, submission_id: String,
                               ...
                               block_name: String, cluster_name: String, school_name: String, has_parent_question: Boolean,
                               parent_question_text: String): Unit = {
    insertQuestion(payload, question_id, solution_id, solution_name, submission_id, user_id, submission_number, value, state_name, district_name, block_name, cluster_name, school_name, has_parent_question, parent_question_text, "multiselect")
  }
  ...
  def numberQuestionType(payload: Option[Map[String, Any]], question_id: String, solution_id: String, solution_name: String, submission_id: String,
                          ...
                          block_name: String, cluster_name: String, school_name: String, has_parent_question: Boolean,
                          parent_question_text: String): Unit = {
    insertQuestion(payload, question_id, solution_id, solution_name, submission_id, user_id, submission_number, value, state_name, district_name, block_name, cluster_name, school_name, has_parent_question, parent_question_text, "number")
  }
  ...
  def sliderQuestionType(payload: Option[Map[String, Any]], question_id: String, solution_id: String, solution_name: String, submission_id: String,
                          ...
                          block_name: String, cluster_name: String, school_name: String, has_parent_question: Boolean,
                          parent_question_text: String): Unit = {
    insertQuestion(payload, question_id, solution_id, solution_name, submission_id, user_id, submission_number, value, state_name, district_name, block_name, cluster_name, school_name, has_parent_question, parent_question_text, "slider")
  }
}