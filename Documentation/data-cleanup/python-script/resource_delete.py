...
# ---------------------------------------------------
# Load config from unified-pipeline.conf
# ---------------------------------------------------
...
_dc   = _conf["data-cleanup"]

DB_HOST  = _dc["database"]["host"]
DB_USER  = _dc["database"]["user"]
DB_PASS  = _dc["database"]["password"]
DB_NAME  = _dc["database"]["dbname"]
ENV      = _dc["database"]["env"]
BROKER   = _dc["kafka"]["broker"]
TOPIC    = _dc["kafka"]["topic"]
GROUP_ID = _dc["kafka"]["group-id"]

LOG_FILE_PATH = _dc["common"]["log-path"]
